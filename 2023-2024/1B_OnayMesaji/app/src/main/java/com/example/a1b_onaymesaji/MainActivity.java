package com.example.a1b_onaymesaji;
    ...
    public void cikis(View view){
        ...
        onay.setPositiveButton("Evet", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(MainActivity.this, "Çıkış Yapılıyor", Toast.LENGTH_LONG).show();
            }
        });
        onay.setNegativeButton("Hayır", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(MainActivity.this, "Çıkış İptal Edildi", Toast.LENGTH_LONG).show();
            }
        });
     onay.show();
    }
